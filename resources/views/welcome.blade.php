...
<body>
    ...
    <div class="font-[sans-serif]">
      <div class="min-h-screen flex fle-col items-center py-6 px-4">
        <div class="grid md:grid-cols-2 items-center gap-10 ml-60 max-w-6xl w-full">
          

          <form class="max-w-md md-ml:auto w-full">
            <h3 class="text-gray-800 text-3xl font-extrabold mb-8">
              Portal de autogestión
              <h2 class="text-gray-800 text-2xl font-semibold">Iniciar sesión</h2>
            </h3>

            <div class="space-y-4">
              <div>
                <input name="email" type="email" autocomplete="email" required class="bg-gray-100 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent" placeholder="Tipo de documento" />
              </div>
              <div>
                <input name="password" type="password" autocomplete="current-password" required class="bg-gray-100 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent" placeholder="Número de documento" />
              </div>
